...
// --- NEW: Import icons for the process section ---
...
// --- DATA FOR THE NEW "OUR PROCESS" SECTION ---
const processSteps = [
    {
        icon: <FiCompass />,
...
// ============================================
// === MAIN HOME COMPONENT (With new section) ===
// ============================================
...
function Home() {
    ...
    return (
        <AnimatedPage>
            ...
            {/* --- THIS IS THE NEW "OUR PROCESS" SECTION --- */}
            ...
            <AboutSection>
                <ArchitectImage 
                    src="https://images.unsplash.com/photo-1581093450021-4a7360e9a6b5?auto=format&fit=crop&w=800"
